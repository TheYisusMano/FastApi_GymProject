...
CREATE TABLE public.inscripciones_membresias (
    id integer NOT NULL,
    id_entrenadores integer NOT NULL,
...
COPY public.entrenadores (id, nombre, apellido, genero, direccion, telefono, email, fecha_registro, especialidad, certifcicacion) FROM stdin;
\.
...
COPY public.inscripciones_membresias (id, id_entrenadores, id_miembros, id_membresia, nombre, caracteristicas, fecha_inicio, fecha_fin, estado, fecha_ultima_actualizacion) FROM stdin;
\.
...
1	prueba	string	0	2025-07-28 00:00:00	t	0.00
\.
...
SELECT pg_catalog.setval('public.membresia_id_seq', 2, true);
...
--
-- Name: inscripciones_membresias inscripciones_membresias_id_entrenadores_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inscripciones_membresias
    ADD CONSTRAINT inscripciones_membresias_id_entrenadores_fkey FOREIGN KEY (id_entrenadores) REFERENCES public.entrenadores(id);


--
-- Name: inscripciones_membresias inscripciones_membresias_id_membresia_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inscripciones_membresias
    ADD CONSTRAINT inscripciones_membresias_id_membresia_fkey FOREIGN KEY (id_membresia) REFERENCES public.membresia(id);


--
-- Name: inscripciones_membresias inscripciones_membresias_id_miembros_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inscripciones_membresias
    ADD CONSTRAINT inscripciones_membresias_id_miembros_fkey FOREIGN KEY (id_miembros) REFERENCES public.miembros(id);
